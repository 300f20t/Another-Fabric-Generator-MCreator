	...
	TradeOfferHelper.
		<#if villagerProfession == "WanderingTrader">registerWanderingTraderOffers(builder -> {
			...
			<#list entries as entry>
				builder.add(<@basicTrade price1, countPrice1, !entry.price2.isEmpty(), entry.price2, entry.countPrice2, entry.offer, entry.countOffer, entry.xp, entry.priceMultiplier/><#sep>
			</#list>
		        );
